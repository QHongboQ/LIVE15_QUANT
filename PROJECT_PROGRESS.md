...
| NOMAD-CONTROL-CENTER-CUTOVER-PREP-001 | BLOCKED / ENVIRONMENT_OPERATOR_INSTALLATION | Current ControlCenter is an `UNPROVEN`, user-writable working-tree/WinSW installation with no verified LocalService credential boundary; no candidate jobspec was created. Detail: `docs/deployment/NOMAD_CONTROL_CENTER_CUTOVER_PREP_001.md`. | Human-approved secure release/install prerequisite; no service mutation in this task |
