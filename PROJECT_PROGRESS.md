...
| NOMAD-FIRST-WORKLOAD-SHADOW-001 | PR_OPEN / acceptance, Maker/Checker, and CI PASS; awaiting human merge | Hash, safety-boundary, and allocation evidence: `docs/deployment/NOMAD_FIRST_WORKLOAD_SHADOW_001.md`. | No cutover or Recorder migration |
