...
| ST-005 | IN_PROGRESS | Archive/purge throughput recovery and 60-minute proof. Measure first; optimize only proven bottleneck; require processing > incoming, declining backlog, controlled DB growth, verified archive, zero attributable WS gap/sync loss. | Runtime/read-only proof; storage mutation separately gated |
