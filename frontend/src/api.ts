...
export type MarketHistory = { schema_version: number; asset: string; ticker: string; window_start: string; window_end: string; generated_at: string; underlying: Array<{ observed_at: string; source: string; close_price: string; minimum_price: string; maximum_price: string }>; probability: Array<{ observed_at: string; sequence: number; yes_bid?: string | null; yes_ask?: string | null; no_bid?: string | null; no_ask?: string | null }>; underlying_last_actual_change_at?: string | null; probability_last_actual_change_at?: string | null; notes: string[]; };
