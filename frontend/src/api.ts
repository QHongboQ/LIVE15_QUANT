...
export const api = {
  ...
  marketHistory: (id: string) => request<Record<string, unknown>>(`/api/markets/${encodeURIComponent(id)}/history`),
  ...
  accountEquityHistory: () => request<EquityHistory>('/api/account/equity-history?profile=production_primary'),
